var sim = {
    steps: {
        0: {
            ...
            elements: [{
                element: 'div',
                styles: 'top: 32.1%;left: 15.2%;height: 2.1%;width: 16%;background:none;border:none',
                correct: 'true',
                goto: 3
            }
            ]
            ...
            rubric: 'Comprueba los datos de marketing del cliente en esta estructura organizativa.',
            elements: [{
                element: 'div',
                styles: 'top: 23.25%;left: 1.7%;height: 17.5%;width: 39.5%;background:none;border:none',
                correct: 'true',
                goto: 6
            }
            ]
